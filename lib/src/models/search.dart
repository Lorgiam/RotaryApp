...
class Search {
    ...
    UsuarioEntity usuarioEntity,
      ...
      Search(
        ...
        informacionComercialEntity:
            informacionComercialEntity ?? this.informacionComercialEntity,
  ...
  factory Search.fromJson(Map<String, dynamic> json) => Search(
        ...
        numeroCedula:
            json["numeroCedula"] == null ? null : json["numeroCedula"],
        nombreCompleto:
            json["nombreCompleto"] == null ? null : json["nombreCompleto"],
        ...
        informacionComercial: json["informacionComercial"] == null
            ? null
            : json["informacionComercial"],
        club: json["club"] == null ? null : json["club"],
        especialidad:
            json["especialidad"] == null ? null : json["especialidad"],
        usuario: json["usuario"] == null ? null : json["usuario"],
        imagen: json["imagen"],
        informacionComercialEntity: json["informacionComercialEntity"] == null
            ? null
            : InformacionComercialEntity.fromJson(
                json["informacionComercialEntity"]),
        ciudadEntity: json["ciudadEntity"] == null
            ? null
            : CiudadEntity.fromJson(json["ciudadEntity"]),
        clubEntity: json["clubEntity"] == null
            ? null
            : ClubEntity.fromJson(json["clubEntity"]),
        especialidadEntity: json["especialidadEntity"] == null
            ? null
            : EspecialidadEntity.fromJson(json["especialidadEntity"]),
        usuarioEntity: json["usuarioEntity"] == null
            ? null
            : UsuarioEntity.fromJson(json["usuarioEntity"]),
      );
...
class EspecialidadEntity {
  ...
  factory EspecialidadEntity.fromJson(Map<String, dynamic> json) =>
      EspecialidadEntity(
        idEspecialidad:
            json["idEspecialidad"] == null ? null : json["idEspecialidad"],
...
class InformacionComercialEntity {
  ...
  factory InformacionComercialEntity.fromJson(Map<String, dynamic> json) =>
      InformacionComercialEntity(
        idInformacion:
            json["idInformacion"] == null ? null : json["idInformacion"],
        nombreComercial:
